...
const fetchData = async () => {
  try {
    loading.value = true;
    const dataResponse = await makeApiCall<SalesOrderResource[]>('GET', '/sales-orders-pending-credit');
            ...
            <tr v-if="data && !loading" v-for="item, index in data" :key="item.id">
              ...
              <td class="text-center">
                <VRow justify="end" align="center" style="flex-wrap:nowrap">
                  <a :href="'/salesorder/treat-credit/'+item.sales_order_number">Proceed</a>
                </VRow>
              </td>
            </tr>
