    ...
    <VRow class="text-center mt-4">
      <VCol>
        <h3 class="sales-receipt-title">
          <strong><u>Cashier Remittance</u></strong>
        </h3>
      </VCol>
    </VRow>
      ...
      <VCol>
        <VCard class="mt-4">
          ...
          <VCardText>
            ...
            <VRow class="mt-2">
              <VCol cols="6">
                <h4>Discrepancy: {{ salesOrder?.cash_discrepancy_name }}</h4>
              </VCol>
              <VCol cols="6">
                <h4> Discrepancy Amount: &#8358; {{ formatNumber(salesOrder?.discrepancy_amount) }}</h4>
              </VCol>
            </VRow>
            <VRow class="mt-2">
              <VCol cols="6">
