...
const navigationLinks: NavigationItem[] = [
...

  {
    ...
    children: [
      ...
      // { title: 'Reports', link: '/coming-soon' },
  ...
  // },
  {
    ...
    children: [
      ...
      { title: 'Level Of Study', link: '/setup/level-of-studies' },
      { title: 'Type Of Application', link: '/setup/type-of-applications' },
      { title: 'Countries', link: '/setup/countries' },
